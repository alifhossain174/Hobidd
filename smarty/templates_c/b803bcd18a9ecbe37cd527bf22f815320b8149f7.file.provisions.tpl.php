<?php /* Smarty version Smarty-3.1.17, created on 2022-02-27 19:43:25
         compiled from "./inc/views/pages/provisions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:112975150160173bfe910468-89089660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b803bcd18a9ecbe37cd527bf22f815320b8149f7' => 
    array (
      0 => './inc/views/pages/provisions.tpl',
      1 => 1645984154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '112975150160173bfe910468-89089660',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_60173bfe962f77_24923589',
  'variables' => 
  array (
    'B_listProvisions' => 0,
    'state' => 0,
...
<?php if ($_valid && !is_callable('content_60173bfe962f77_24923589')) {function content_60173bfe962f77_24923589($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['B_listProvisions']->value) {?>
	<form method="post" action="?s=<?php echo $_smarty_tpl->tpl_vars['state']->value;?>
" class="well form-inline ajaxSearchForm">
		<a class="btn btn-primary" href="?s=createProvision"><i class=" icon-plus-sign"></i> Verpflegung hinzufügen</a>
...
?>
			<tr>
				...
				<td nowrap="nowrap" style="text-align:center;">
					<a href="?s=editProvision&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['id'];?>
" title="Bearbeiten" class="glyphicon glyphicon-pencil"></a>
					<a href="?s=deleteProvision&id=<?php echo $_smarty_tpl->tpl_vars['val']->value['id'];?>
...
<?php if ($_smarty_tpl->tpl_vars['B_createProvision']->value||$_smarty_tpl->tpl_vars['B_editProvision']->value) {?>
...
"
		...
		<div id="form-header">
			<h4>Verpflegung <?php if ($_smarty_tpl->tpl_vars['state']->value=="createProvision") {?>hinzufügen<?php } else { ?>bearbeiten<?php }?></h4>
		</div>
        ...
        <?php if (!$_smarty_tpl->tpl_vars['ajax']->value) {?>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<a href="?s=listProvisions" class="btn btn-default">Abbrechen</a>
				</div>
			</div>
        <?php }?>
