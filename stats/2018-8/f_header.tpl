...
{* SUCHFELD TOP *}
{*<div class="container d-none d-lg-block mb-4 mt-2" style="background: #dbc4b7;">
...
<div class="d-none d-lg-block"> {*hauptmenü*}
	<div class="col px-0">
		<nav class="navbar navbar-expand-lg navbar-dark py-md-0"
			 style="background-color: #840058;"> {*BANNERHintergrundfarbe - variante 1 #364652 / variante 2 #3f3f3f*}
