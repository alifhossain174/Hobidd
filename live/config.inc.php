...
define('ROOT_PATH', DOCKER ? '/var/www/html/' : '/var/www/hobidd.com/');
...
// DOCKER ? 'mysql://root:r33t@db/c30hobbidd?new_link=true'
// : 'mysql://c30hobbidd:crhzHE!T92B@localhost/c30hobbidd?new_link=true'
define(
    'DSN',
    DOCKER ? 'mysql://root:r33t@db/c30hobbidd?new_link=true'
        : 'mysql://c30hobbidd:NEWcrhzHE!T92BA+@localhost/c30hobbidd?new_link=true'
);
