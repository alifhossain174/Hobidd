...
<head>
	...
	<link
		href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i|Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i"
		rel="stylesheet">
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500;600;700;800&display=swap |Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i"
		rel="stylesheet">
		...
		<div class="d-lg-none mobile-menu">
			<div class="col px-0">
				<nav class="navbar navbar-expand-lg navbar-light py-md-2">
					<button class="navbar-toggler ml-15" type="button" data-toggle="collapse"
	...
	<div class="d-none d-lg-block"> {*MENUE UNTER DEM BANNER*}
		...
		<div class="col px-0">
			<nav class="navbar navbar-expand-lg navbar-dark py-md-20" style="background-color: #1490d0;">
				{* helleres BLAU 51b1ed ORANGE ff9600  alt blau 2c7affBANNERHintergrundfarbe hellblau #38b7e7 / dunklelblau #191919 / hellblau #b4d9ff - variante 1 #364652 / variante 2 #3f3f3f*}
