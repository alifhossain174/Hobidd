                                    ...
                                    <div style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #555555; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 18px;">
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: justify; mso-line-height-alt: 21px; margin: 0;">
                                                we are very pleased that you were able to sell a stay advertised on
                                                hobidd. Herewith we send you the purchase confirmation. As a next step,
                                                please contact your guest directly to confirm the booking and to arrange
                                                the payment.</p>
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: justify; mso-line-height-alt: 21px; margin: 0;">
                                                 </p>
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: justify; mso-line-height-alt: 21px; margin: 0;">
                                                Sollten Sie weitere Informationen benötigen, wenden Sie sich bitte per
                                                Mail an unser Support-team unter <a href="mailto:support@hobidd.com"
                                                                                    style="text-decoration: underline; color: #0068A5;"
                                                                                    title="support@hobidd.com">support@hobidd.com</a>
                                                wenden. </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                        ...
                                        <div style="line-height: 1.5; font-size: 12px; color: #555555; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 18px;">
                                            <table style="padding-left:10px;padding-right:10px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px; word-break: break-word; margin: 0;">
                                                            {VENDOR_COMPANY}<br/>T: {VENDOR_PHONE}<br/>M:
                                                            {VENDOR_MOBILE}<br/>E: {VENDOR_EMAIL}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap><p
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px; word-break: break-word; margin: 0;">
                                                            &euro; {OFFERED_PRICE} inkl. MwSt.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td nowrap><p
                                                    ...
                                                    <td>
                                                        <p style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px; word-break: break-word; margin: 0;">
                                                            {FIRSTNAME}
                                                            {LASTNAME}<br/>{STREET}<br/>{ZIP-CODE}-{CITY}<br/>{COUNTRY}<br/><br/>T:
                                                            {PHONE}<br/>{EMAIL}</p>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;">
                                                <span style="font-size: 14px;">Please remember to delete all not longer current offers and of course to publish ADDITIONAL ones.</span>
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                 </p>
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: justify; mso-line-height-alt: 21px; margin: 0;">
                                                Do you need further information, please feel free to contact our support
                                                team b mail at <a href="mailto:support@hobidd.com"
                                                                  style="text-decoration: underline; color: #0068A5;"
                                                                  title="support@hobidd.com">support@hobidd.com</a>
                                                DANKE. </p>
